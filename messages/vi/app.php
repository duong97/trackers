...
return [
    ...
    'Category'              =>'Loại',
    'If you sign in using social networks, add a password to log in with email'=>'Nếu bạn đăng nhập bằng mạng xã hội, thêm mật khẩu để đăng nhập bằng email',
    'Forgot password?'      =>'Quên mật khẩu?',
    'Forgot password'       =>'Quên mật khẩu',
    'We will send a temporary password to your email, you must change your password immediately for security reasons.'=>'Chúng tôi sẽ gửi mật khẩu tạm thời vào email của bạn, bạn phải đổi mật khẩu ngay vì lý do bảo mật.',
    'Enter your email'      =>'Nhập email của bạn',
    'This email does not match any accounts'=>'Email này không trùng khớp với bất kỳ tài khoản nào',
